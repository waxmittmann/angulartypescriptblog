...
module blogposts {
    ...
    export class LocalStorageBlogPostStore implements BlogPostStore {
        ...
        add(newPostData : BlogPostData): ng.IPromise<BlogPost> {
            ...
            return this.doWithPosts(function (posts:BlogPost[]) {
                console.log("now it is: " + JSON.stringify(newPostData));
                var newPostData = new BlogPost(that.nextId(), newPostData.title, newPostData.body);
